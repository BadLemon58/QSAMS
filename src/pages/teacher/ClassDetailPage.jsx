          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2.5 self-start md:self-auto">
              ...
              <button
                ...
                className="bg-white !text-red-500 hover:bg-[#f1f5f9] font-bold text-xs py-2.5 px-4 rounded-[12px] shadow-sm transition-all flex items-center gap-1.5"
                title="Delete this class"
              >
                <MorphIcon icon={Trash2} size={14} className="!text-red-500" /> Delete Class
              </button>
            </div>
          </div>
        </div>
